...
func (s *Store) SaveTaskWorktreeLink(record TaskWorktreeLinkRecord) error {
	...
	s.tryAppendEvent(events.AggregateTask, record.TaskID, events.TaskWorktreeLinked,
		events.TaskWorktreeLinkedPayload{
...
func (s *Store) DeleteTaskWorktreeLinksByWorktreeID(worktreeID string) error {
	s.tryAppendEvent(events.AggregateWorktree, worktreeID, events.TaskWorktreeLinksCleared,
		events.TaskWorktreeLinksClearedPayload{WorktreeID: worktreeID},
		events.AggregateWorktree, worktreeID)
